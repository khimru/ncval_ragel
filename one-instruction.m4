...
%%{
  ...
  define(｢operand0_st｣, )
  define(｢operand0_x87｣, )
  define(｢operand0_x87_16bit｣, )
  define(｢operand0_x87_32bit｣, )
  define(｢operand0_x87_64bit｣, )
  define(｢operand0_x87_bcd｣, )
  define(｢operand0_x87_env｣, )
  define(｢operand0_x87_mmx_xmm_state｣, )
  define(｢operand0_x87_state｣, )
  define(｢operand0_xmm｣, )
  define(｢operand0_ymm｣, )
  ...
  define(｢operand1_128bit｣, )
  define(｢operand1_256bit｣, )
  define(｢operand1_creg｣, )
  define(｢operand1_dreg｣, )
  define(｢operand1_ds_rsi｣, )
  define(｢operand1_es_rdi｣, )
  define(｢operand1_absolute_disp｣, )
  define(｢operand1_farptr｣, )
  define(｢operand1_float32bit｣, )
  define(｢operand1_float64bit｣, )
  define(｢operand1_from_modrm_reg｣, )
  define(｢operand1_from_modrm_rm｣, )
  define(｢operand1_from_opcode｣, )
  define(｢operand1_from_vex｣, )
  ...
  define(｢operand2_128bit｣, )
  define(｢operand2_256bit｣, )
  define(｢operand2_float32bit｣, )
  define(｢operand2_float64bit｣, )
  define(｢operand2_from_is4｣, )
  define(｢operand2_from_modrm_reg｣, )
  define(｢operand2_from_modrm_rm｣, )
  define(｢operand2_from_vex｣, )
  define(｢operand2_immediate｣, )
  define(｢operand2_rax｣, )
  define(｢operand2_rcx｣, )
  define(｢operand2_rm｣, )
  define(｢operand2_second_immediate｣, )
  define(｢operand2_xmm｣, )
  define(｢operand2_ymm｣, )
  define(｢operand3_8bit｣, )
  define(｢operand3_128bit｣, )
  define(｢operand3_256bit｣, )
  define(｢operand3_immediate｣, )
  define(｢operand3_float32bit｣, )
  define(｢operand3_float64bit｣, )
  define(｢operand3_from_is4｣, )
  define(｢operand3_from_modrm_rm｣, )
  define(｢operand3_rm｣, )
  define(｢operand3_second_immediate｣, )
  define(｢operand3_xmm｣, )
  define(｢operand3_ymm｣, )
  define(｢operand4_2bit｣, )
  define(｢operand4_immediate｣, )
  ...
  define(｢_instruction_name_action｣, ｢action instruction_｢｣clean_name($1) { }｣)
